...
import {
    store as storePendidikan,
    update as updatePendidikan,
    destroy as destroyPendidikan,
} from '@/routes/pendidikan';
        ...
        <div class="space-y-4">
            ...
            >
                <div class="flex flex-col items-center gap-2">
                    ...
                    />
                    <p>
                        Belum ada data pendidikan. Silakan tambahkan data baru.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                :key="item.id"
                class="flex flex-col justify-between gap-4 rounded-xl border p-5 shadow-sm transition-all hover:bg-neutral-50/50 hover:shadow-md sm:p-6 md:flex-row md:items-start dark:hover:bg-neutral-900/50"
            >
        ...
        <Dialog :open="isDialogOpen" @update:open="isDialogOpen = $event">
            <DialogContent class="sm:max-w-[500px]">
                <form @submit.prevent="submitForm" class="space-y-5">
                    <DialogHeader>
                        <DialogTitle>{{
                            isEditing ? 'Edit Pendidikan' : 'Tambah Pendidikan'
                        }}</DialogTitle>
                        <DialogDescription>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="grid gap-2">
                                ...
                                />
                                <InputError
                                    :message="form.errors.tahun_mulai"
                                />
                            </div>
                            <div class="grid gap-2">
                                ...
                                <Input
                                    id="tahun_selesai"
                                    type="number"
                                    v-model="form.tahun_selesai as any"
                                    placeholder="Kosongkan jika masih studi"
                                />
                                <InputError
                                    :message="form.errors.tahun_selesai"
                                />
                            </div>
                        </div>
                        ...
                        <div class="grid gap-2">
                            <Label for="deskripsi"
                                >Deskripsi Kegiatan / Prestasi</Label
                            >
                            <Textarea
                                id="deskripsi"
